...
using System.Text; //var phantomJS = new PhantomJS();
            ...
            try
            {
                ...
                else if (browserType.ToLower().Equals("other"))
                {
                    ...
                    foreach (var rectangle in rectangles)
                    {
                        ...
                        {
                            screenshot.SaveAsFile(evidencePath + "\\Chrome\\ScreenShots\\" + testName + "_" + DateTime.Now.ToString("hh_mm_ss") + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
                            break;
                        }
