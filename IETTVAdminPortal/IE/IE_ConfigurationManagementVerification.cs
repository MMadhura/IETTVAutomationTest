...
{
    [TestFixture]
    class IE_ConfigurationManagementVerification
    {
        ...
        public void TVAdmin_001_VerMandatoryField()
        {
            try
            {
                ...
                Assert.AreEqual("#ff0000", borderColor);
        ...
        public void TVAdmin_003_VerCancelButtonFunc()
        {
            try
            {
                ...
                for (int i = 0; i < columnName.Length; i++)
                {
                    ...
                    iWait.Until(ExpectedConditions.ElementIsVisible(By.Id("ContentPlaceHolder1_repConfiguration_lnkEdit_"+i)));
