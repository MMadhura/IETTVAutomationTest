...
namespace IETTVAdminPortal.IE
{
    ...
    [TestFixture]
    public class IE_ChannelManagementVerification
    {
        ...
        public void TVAdmin_002_CreateChannel()
        {
            try
            {
                ...
                string channelName = CreateChannel("Category Name");
        ...
        public void TVAdmin_003_CancelButtonFunc()
        {
            try
            {
                ...
                iWait.Until(ExpectedConditions.ElementToBeClickable(driver.FindElement(By.Id(OR.readingXMLFile("ChannelManagement", "ChannelType", "TVAdminPortalOR.xml")))));
                ...
                iWait.Until(ExpectedConditions.ElementToBeClickable(driver.FindElement(By.Id(OR.readingXMLFile("ChannelManagement", "ChannelPosition", "TVAdminPortalOR.xml")))));
                ...
                iWait.Until(ExpectedConditions.ElementToBeClickable(driver.FindElement(By.Id(OR.readingXMLFile("ChannelManagement", "PricingType", "TVAdminPortalOR.xml")))));
        ...
        public void TVAdmin_007_MandatoryFieldValidation()
        {
            try
            {
                ...
                //Verifying that Mandatroy message is dispayed correclty for Channel Field ?
                ...
                //Verifying that Mandatory message is dispayed correclty for Category dropdown ?
                ...
                //Verifying that Mandatory message is dispayed correclty for Pricing Type dropdown ?
                ...
                //Verifying that Mandatory message is dispayed correclty for Channel Field ?
                ...
                SelectElement ChannelCategorySelector = new SelectElement(driver.FindElement(By.Id(OR.readingXMLFile("ChannelManagement", "ChannelCategory", "TVAdminPortalOR.xml"))));
                ...
                if (ChannelCategorySelector.Options.Count > 0)
                {
                    ...
                    //Verifying that Mandatory message is dispayed for Category Field ?
                    Thread.Sleep(2000);
                ...
                SelectElement PricingTypeSelector = new SelectElement(driver.FindElement(By.Id(OR.readingXMLFile("ChannelManagement", "PricingType", "TVAdminPortalOR.xml"))));
                ...
                log.Info("TVAdmin_007_MendatoryFieldValidation test completed" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
        ...
        public void TVAdmin_008_EditingChannel()
        {
            try
            {
                ...
                log.Info("Inside Scenarion 1 of Editing Channel Functionality" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
                ...
                String channeltypetext = channeltype.SelectedOption.Text;
                ...
                iWait.Until(ExpectedConditions.StalenessOf(driver.FindElement(By.Id("ContentPlaceHolder1_ddlChannelType"))));

                String pricingTypetext = new SelectElement(driver.FindElement(By.Id("ContentPlaceHolder1_ddlChannelType"))).SelectedOption.Text;


                log.Info("Editing background color picker information" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
                ...
                log.Info("Generating background color collection" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
                ...
                log.Info("Clicking on body to close color picker" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());

                //Clicking on Body to close color picker.
                driver.FindElement(By.Id("ContentPlaceHolder1_rdoChannelAccessType")).FindElements(By.TagName("tr"))[0].FindElement(By.TagName("td")).FindElement(By.TagName("label")).Click();

                log.Info("Editing player information" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
                ...
                log.Info("Clicking on Save button" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
                //clicking on save button
                ...
                foreach (Element currentRow in rowListNsoup)
                {
                    ...
                    if (attr["class"].Equals("GridRowStyle") || attr["class"].Equals("AltGridStyle"))
                    {
                        ...
                        if (columData.Equals(channelName))
                        {
                            ...
                            log.Info("Background COloe :: " + rowListSelenium[rowCounter + 1].FindElements(By.TagName("td"))[8].FindElement(By.Id("ContentPlaceHolder1_gvChannelCreation_colorDiv_" + rowCounter)).GetCssValue("background-color"));
