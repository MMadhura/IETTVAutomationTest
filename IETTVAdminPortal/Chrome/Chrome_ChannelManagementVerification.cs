...
namespace IETTVAdminPortal.Chrome
{
    ...
    [TestFixture]
    public class Chrome_ChannelManagementVerification
    {
        ...
        Utility_Functions uf = new Utility_Functions();                                          // Instantiating Utilities function class                                
        ...
        public string CreateChannel(String CategoryName)
        {
            ...
            string channelNameWithGuid = "Chan " + uf.getShortGuid();  // Concatenating the GUID 
            ...
            string categoryName = cf.readingXMLFile("Admin", "Category Management", "categoryname", "TestCopy.xml");
            ...
            //#region Getting control of Player dropdown
            ...
            //#region Getting control to Channel Upload Element
            ...
            ChannelDataList.Add(cf.readingXMLFile("Admin", "Category Management", "categoryname", "TestCopy.xml"));                                     // (1) Adding Selected Category into List.
            ChannelDataList.Add(ChannelTypeSelector.SelectedOption.Text.Trim());  //(2) ChannelType
            ChannelDataList.Add("Paid");                                         // (3) pricing type
        ...
        [Test]
        public void TVAdmin_001_CreateChannel()
        {
            try
            {
                ...
                cf.writingIntoXML("Admin", "Channel Management", "channelname", channelName, "TestCopy.xml");
        ...
        //        #region Region to select Category
        ...
        //        log.Info("Inside Scenarion 1" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
        ...
        //        Assert.AreEqual(currentColour, driver.FindElements(By.ClassName("evo-colorind"))[0].GetAttribute("style")); //verifying the prepopulated background is old one
        ...
        //        #region Scenarion 3 : Chekcing Duplication Message at the time of Edit
