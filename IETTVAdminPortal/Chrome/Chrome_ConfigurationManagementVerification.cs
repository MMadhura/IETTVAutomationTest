...
namespace IETTVAdminPortal.Chrome
{
    ...
    [TestFixture]
    public class Chrome_ConfigurationManagementVerification
    {
            ...
            foreach (Element currentRow in rowListNsoup)
            {
                ...
                if (attr["class"].Equals("config_table"))
                {
                    ...
                    if (columData.Equals(Text))
                    {
                        ...
                        //rowList[rowcounter + 1].FindElements(By.TagName("td"))[2].FindElement(By.Id("ContentPlaceHolder1_repConfiguration_lnkEdit_"+rowcounter)).Click();
                    }
                    rowcounter++;
                }
            }
        ...
        public void TVAdmin_001_VerMandatoryField()
        {
            try
            {
                ...
                String borderColor =  GetValueField(position).GetCssValue("border-color").ToString();
                ...
                Thread.Sleep(3000);
                borderColor = driver.FindElement(By.Id("ContentPlaceHolder1_repConfiguration_txtConfigValue_0")).GetCssValue("border-color").ToString();
                Assert.AreEqual("rgb(255, 0, 0)", borderColor);
