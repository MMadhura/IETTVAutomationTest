...
{
    [TestFixture]
    class Chrome_CategoryManagementVerification
    {
        ...
        public string CreatingCategory(String categoryPosition)
        {
            ...
            categoryNameWithGuid = categoryNameWithGuid + uf.getShortGuid();
        ...
        public void TVAdmin_001_CreateCategory()
        {
            try
            {
                ...
                if (rowCount == 0)
                {
                    categoryName = CreatingCategory("first");
                ...
                cf.writingIntoXML("Admin", "Category Management", "categoryname", categoryName, "TestCopy.xml");
        ...
        public static IEnumerable<object> CategorynameDataSource
        {
            ...
            get
            {
                ...
                string ExcelDataPath = AppDomain.CurrentDomain.BaseDirectory + "\\TestData_AdminPortal\\" + "NormalDataset_IET_Admin.xlsx";
        ...
        #region InternalPortalLogin
        //public void InternalPortalLogin()
        //{
        //    driver = new ChromeDriver();
        //    driver.Manage().Window.Maximize();

        //    string internalPortalURL = "http://192.168.1.25:8090/httpclient.html?u=http://www.gstatic.com/generate_204";
        //    driver.Navigate().GoToUrl(internalPortalURL);

        //    Boolean loginBlock = IsElementPresent(driver, By.ClassName("datablock"));
        //    if (loginBlock)
        //    {
        //        driver.FindElement(By.Name("username")).SendKeys("Madhura.Mungekar");
