...
{
    [TestFixture]
    class Firefox_IETMemberRegistration
    {
        ...
        {
            log.Info("Redirected to registration Page" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
            ...
            log.Info("Clicked on Login link" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
            ...
            log.Info("Clicked on 'Not registered with The IET? Register here' link" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber()); 
        }
        ...
        public void TVWeb_009_MandatoryFieldsValidation()
        {
            ...
            try
            {
                ...
                log.Info("TVWeb_009_MandatoryFieldsValidation test completed" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());
