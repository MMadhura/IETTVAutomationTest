...
namespace IETTVWebportal.IE
{
    ...
    [TestFixture]
    class IE_IETMemberRegistration
    {
        ...
        {
            log.Info("Redirecting to registration Page" + " at line:" + new StackTrace(true).GetFrame(0).GetFileLineNumber());

            Console.WriteLine("Title in redirect:" + driver.Title.ToString());
        ...
        public void TVWeb_001_IETMemberRegistration()
        {
            ...
            driver.FindElement(By.Id(or.readingXMLFile("NonIETMemberRegistration", "BannerMessageOkButton", "TVWebPortalOR.xml"))).Click();
            ...
            iWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.CssSelector(or.readingXMLFile("NonIETMemberRegistration", "PleaseWaitLoader", "TVWebPortalOR.xml"))));

            iWait.Until(ExpectedConditions.ElementExists(By.Id(or.readingXMLFile("NonIETMemberRegistration", "UserName", "TVWebPortalOR.xml"))));

                // Entering Username
            driver.FindElement(By.Id(or.readingXMLFile("NonIETMemberRegistration", "UserName", "TVWebPortalOR.xml"))).SendKeys(completeDataList[5]);

                //Entering password
            driver.FindElement(By.Id(or.readingXMLFile("NonIETMemberRegistration", "Password", "TVWebPortalOR.xml"))).SendKeys(completeDataList[6]);

                // Clicking on Login button
                driver.FindElement(By.ClassName(or.readingXMLFile("NonIETMemberRegistration", "LoginButton", "TVWebPortalOR.xml"))).Click();

                // Waiting untill loeader is displayed
        ...
        public void TVWeb_004_ExistingEmailValidation()
        {
            ...
            driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "FinalMember", "TVWebPortalOR.xml"))).Click();
                ...
                Assert.AreEqual("Registration failed as email address already existsOK", driver.FindElement(By.ClassName(or.readingXMLFile("IETMemberRegistration", or.readingXMLFile("IETMemberRegistration", "Warningmsg", "TVWebPortalOR.xml"), "TVWebPortalOR.xml"))).Text.Trim());
        ...
        public void TVWeb_005_EmailMatchingValidation()
        {
            ...
            //driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "IEtConfirmPassword", "TVWebPortalOR.xml"))).SendKeys("Rave1234");   //Entering confirmPassword
            ...
            //driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "ConfirmEmail", "TVWebPortalOR.xml"))).SendKeys("autmationSelenium12@email.com");   //Entering Confirm Email
            //driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "IetMemberContinue", "TVWebPortalOR.xml"))).Click();
        ...
        public void TVWeb_009_MandatoryFieldsValidation()
        {
            ...
            String IEBrowser = uf.getRunningBrowser(driver, driver.FindElement(By.TagName("body")));
             Console.WriteLine("Running Browser:" +IEBrowser);

            if (IEBrowser.Equals("IE11"))
                expectedStyle = "padding: 2px 1px; border: 1px solid rgb(197, 0, 0); border-image: none;";  //for Browser IE11
            else if (IEBrowser.Equals("IE9"))
                expectedStyle = "padding: 2px 1px; border: 1px solid rgb(197, 0, 0);";
            else if (IEBrowser.Equals("IE10"))
                expectedStyle = "padding: 2px 1px; border: 1px solid rgb(197, 0, 0); border-image: none;";
            ...
            iWait.Until(ExpectedConditions.ElementIsVisible(By.Id(or.readingXMLFile("IETMemberRegistration", "BtnYes", "TVWebPortalOR.xml"))));
            executor.ExecuteScript("arguments[0].click();", driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "BtnYes", "TVWebPortalOR.xml"))));

            iWait.Until(ExpectedConditions.ElementIsVisible(By.Id(or.readingXMLFile("IETMemberRegistration", "Check", "TVWebPortalOR.xml"))));
            executor.ExecuteScript("arguments[0].click();", driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "Check", "TVWebPortalOR.xml"))));
            ...
            iWait.Until(ExpectedConditions.ElementIsVisible(By.Id(or.readingXMLFile("NonIETMemberRegistration", "BannerMessageOkButton", "TVWebPortalOR.xml"))));
            Console.WriteLine("Message Warningi :: " + driver.FindElement(By.ClassName(or.readingXMLFile("IETMemberRegistration", "Warningmsg", "TVWebPortalOR.xml"))).Text.Trim());
            ...
            iWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.Id(or.readingXMLFile("NonIETMemberRegistration", "BannerMessageOkButton", "TVWebPortalOR.xml"))));
            ...
            Console.WriteLine("Applying Jquery before Style change");
            uf.isJqueryActive(driver);
            ...
            actualStyle = driver.FindElement(By.Id(or.readingXMLFile("IETMemberRegistration", "ConfirmEmail", "TVWebPortalOR.xml"))).GetAttribute("style");
            Assert.AreEqual(expectedStyle, actualStyle);                    //Checking red border appears around Member Ship ID field.
