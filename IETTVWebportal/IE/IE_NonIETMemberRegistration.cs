...
{
    class IE_NonIETMemberRegistration
    {
        ...
        Utility_Functions uf = new Utility_Functions();                           // Instantiate object for Utility functions                                  
        ...
        public void TVWeb_001_Registration()
        {
            ...
            Assert.AreEqual(register_Successful_Message, "You have registered successfully.OK");
            ...
            iWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.CssSelector("div > h3")));     //Waiting for please wait option
            ...
            Assert.AreEqual(welcome_user_name, "Welcome: " + username_surname);   //validating username and surname who logged-in
