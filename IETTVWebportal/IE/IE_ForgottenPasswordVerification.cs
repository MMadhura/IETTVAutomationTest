...
{
    [TestFixture]
    class IE_ForgottenPasswordVerification
    {
        ...
        public void TVWeb_001_VerifyForgottenPassword()
        {
            ...
            try
            {
                ...
                {
                    // For IE Browser
                    if (uf.getRunningBrowser(driver, driver.FindElement(By.TagName("body"))).Equals("IE10"))
                    {
                        Assert.AreEqual("padding: 2px 1px; border: 1px solid rgb(197, 0, 0);", userBorder);
                    }
                    else
                    {
                        Assert.AreEqual("padding: 2px 1px; border: 1px solid rgb(197, 0, 0); border-image: none;", userBorder);
                    }
