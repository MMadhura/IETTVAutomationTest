...
{
    [TestFixture]
    public class Chrome_BuyVideoVerification
    {
        ...
        #region Constructors
        public Chrome_BuyVideoVerification()
        {

        }

        public Chrome_BuyVideoVerification(IWebDriver driver, ILog log1, IJavaScriptExecutor Executor, IWait<IWebDriver> iWait)
        {
            this.driver = driver;
        ...
        public void VerifyBuyVideo(string videoname)
        {
            try
            {
                ...
                iWait.Until(ExpectedConditions.ElementIsVisible((OR.GetElement("BuyVideoVerification", "PremiumVideoBTN", "TVWebPortalOR.xml"))));
                ...
                //Handling pop up message
                iWait.Until(ExpectedConditions.ElementIsVisible((OR.GetElement("BuyVideoVerification", "BuyVideoDialogue", "TVWebPortalOR.xml"))));  // Waiting for Popup window to appear after clicking on buy video

                driver.FindElement((OR.GetElement("BuyChannelVerification", "BtnCheckOutClass", "TVWebPortalOR.xml"))).Click();

                uf.isJqueryActive(driver);

                iWait.Until(ExpectedConditions.InvisibilityOfElementLocated((OR.GetElement("SeriesManagement", "OverlayWait", "TVWebPortalOR.xml"))));

                iWait.Until(ExpectedConditions.ElementIsVisible((OR.GetElement("BuyVideoVerification", "AddressTable", "TVWebPortalOR.xml"))));
